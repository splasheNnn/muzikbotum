...
client.on("guildCreate", async guild => {
  const izuku = new MessageEmbed()
    ...
    .addField('✯ |  !!yardım === Müzik komutlarını listeler','✯ |  !!çal === İsmini yazdığınız şarkıyı çalmaya başlar','✯ |  !!bitir === Çalan şarkıyı bitirir','✯ |  !!geç === Çalan şarkıdan bir sonraki şarkıya geçer','✯ |  !!şarkıyageç === Sıradan numarasını verdiğiniz bir şarkıya geçer','✯ |  !!durdur === Şarkıyı durdurur','✯ |  !!devamet === Şarkıyı devam ettirir','✯ |  !!sil === Sıradan numarasını verdiğiniz bir şarkıyı siler','✯ |  !!playlist === YouTubeden bir playlist çalar','✯ |  !!karıştır === Şarkı sırasındaki şarkıları karışık olarak çalar.','✯ |  !!döngü === Şarkıyı sürekli çalacak şekilde döngülü olarak ayarlar','✯ |  !!volume === Şarkının sesini ayarlarsınız',)
