...
module.exports = {
  async play(song, message) {
    ...
    try {
      ...
      var x1 = (reaction, user) => reaction.emoji.name === '⏭' && user.id ===  message.author.id;
      var x2 = (reaction, user) => reaction.emoji.name === '⏯' && user.id ===  message.author.id;
      var x3 = (reaction, user) => reaction.emoji.name === '🔁' && user.id ===  message.author.id;
      var x4 = (reaction, user) => reaction.emoji.name === '⏹' && user.id ===  message.author.id;
